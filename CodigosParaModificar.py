...
#print(ListaDeAlumnos[1][Longitud-3:Longitud-1])
i=0     #Contador
...
while i<len(ListaDeAlumnos):
    ...
    if ListaDeAlumnos[i][Longitud-3:Longitud-1]=="10":
        ...
        """if ListaDeAlumnos[i][Longitud-3:Longitud-1]=="10":
            ...
            x=float(ListaDeAlumnos[i][Longitud-4:Longitud-1])
    elif ListaDeAlumnos[i][Longitud-2:Longitud-1]=="1" or "2" or "3" or "4" or "5" or "6" or "7" or "8" or "9":
